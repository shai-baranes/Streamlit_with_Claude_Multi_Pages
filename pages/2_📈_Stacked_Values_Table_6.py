...
selectable_columns = [c for c in df_filtered.columns if c != time_col and c != get_seconds_column(df_filtered)]
...
def render_stacked_table() -> None:
    ...
    st.multiselect(
        ...
        help="The first selected column is the anchor column. Time and Δt [s] are always shown on the left.",
    )
